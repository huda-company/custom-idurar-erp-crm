...
import ItemRowBill from '@/components/BillPanel/ItemRowBill';

import MoneyInputFormItem from '@/components/MoneyInputFormItem';

export default function BillForm({ subTotal = 0, current = null }) {
    ...
    <>
      ...
      <Form.List name="items">
        {(fields, { add, remove }) => (
          <>
            {fields.map((field) => (
              <ItemRowBill key={field.key} remove={remove} field={field} current={current}></ItemRowBill>
            ))}
            <Form.Item>
              <Button
                type="dashed"
      ...
      <div style={{ position: 'relative', width: ' 100%', float: 'right' }}>
        <Row gutter={[12, -5]}>
          <Col className="gutter-row" span={5}>
            <Form.Item>
              <Button type="primary" onSubmit={handleSubmit} htmlType="submit" icon={<PlusOutlined />} block>
                Save Bill
              </Button>
            </Form.Item>
          </Col>
